...
import { NotificationSocketService, notificationSocketService as notificationSocketServiceInstance } from './services/socketService';
...
export { notificationSocketService };
